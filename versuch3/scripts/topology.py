...
def conf(network):
    ...
    network['r1'].cmd('ip addr add 10.0.1.65/31 dev r1-eth2')
    ...
    network['r2'].cmd('ip addr add 10.0.1.64/31 dev r2-eth1')
    network['r2'].cmd('ip route add 10.0.1.2 via 10.0.1.64')
